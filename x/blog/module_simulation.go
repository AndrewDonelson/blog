...
const (
	...
	opWeightMsgCreateImage = "op_weight_msg_create_image"
	// TODO: Determine the simulation weight value
	defaultWeightMsgCreateImage int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgCreateImage int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgCreateImage, &weightMsgCreateImage, nil,
		func(_ *rand.Rand) {
			weightMsgCreateImage = defaultWeightMsgCreateImage
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateImage,
		blogsimulation.SimulateMsgCreateImage(am.accountKeeper, am.bankKeeper, am.keeper),
	))
